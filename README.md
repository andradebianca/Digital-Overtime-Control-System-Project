# Sistema Digital de Controle de Horas Extras – Parceria com a Startup Base27
...
-> O projeto deve ser executado em um compilador online para uma execução sem erros. Utilizamos o Replit para compilação, porém, como o replit não funciona a função "system("pause")" substituímos manualmente por getchar(); getchar();.
